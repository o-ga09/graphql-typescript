...
export type NutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Nutation'] = ResolversParentTypes['Nutation']> = {
  createAuthor?: Resolver<Maybe<ResolversTypes['Author']>, ParentType, ContextType, RequireFields<NutationCreateAuthorArgs, 'name'>>;
  createNote?: Resolver<Maybe<ResolversTypes['Note']>, ParentType, ContextType, RequireFields<NutationCreateNoteArgs, 'content' | 'tags' | 'title'>>;
  deleteAuthor?: Resolver<Maybe<ResolversTypes['Author']>, ParentType, ContextType, RequireFields<NutationDeleteAuthorArgs, 'id'>>;
  deleteNote?: Resolver<Maybe<ResolversTypes['Note']>, ParentType, ContextType, RequireFields<NutationDeleteNoteArgs, 'id'>>;
  updateAuthor?: Resolver<Maybe<ResolversTypes['Author']>, ParentType, ContextType, RequireFields<NutationUpdateAuthorArgs, 'id'>>;
  updateNote?: Resolver<Maybe<ResolversTypes['Note']>, ParentType, ContextType, RequireFields<NutationUpdateNoteArgs, 'id'>>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
